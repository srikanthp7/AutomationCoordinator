...
public final class TopologicalSort {
     ...
     */
    public static CopyOnWriteArrayListWithStatus<Node> sort(DirectedGraph g) throws IllegalArgumentException {
         ...
         */
        CopyOnWriteArrayListWithStatus<Node> result = new CopyOnWriteArrayListWithStatus<Node>();
     ...
     */
    private static void explore(final Node node, DirectedGraph g,
                                    List<Node> ordering, Set<Node> visited,
                                    Set<Node> expanded) throws IllegalArgumentException {
        ...
        for (final Node predecessor: g.edgesFrom(node))
    ...
    private static  DirectedGraph reverseGraph(DirectedGraph g) {
         ...
         */
        for (final Node node: g)
            for (final Node endpoint: g.edgesFrom(node))
