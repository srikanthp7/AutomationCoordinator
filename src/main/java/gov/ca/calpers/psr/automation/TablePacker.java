...
public class TablePacker {
	 ...
	 * @param table the table
	 */
	public synchronized void pack(JTable table) {
		if (!table.isShowing())
			throw new IllegalStateException("table must be showing to pack");

		if (table.getColumnCount() == 0)
			return;
		System.out.println("Table Packer loop #1.");
		...
		System.out.println("Table Packer loop #2.");
		...
		System.out.println("Table Packer loop #3.");
