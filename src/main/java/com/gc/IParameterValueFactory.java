...
public interface IParameterValueFactory extends com.gc.IBaseFactory {
	// Methods:
	/**
	 * <p>
	 * For HP internal use only. The number of parameters for each test
	 * instance.
	 * </p>
	 * <p>
