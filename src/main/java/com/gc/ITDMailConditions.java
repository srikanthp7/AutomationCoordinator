...
public interface ITDMailConditions extends com.gc.IObjectLockingSupport {
	// Methods:
	/**
	 * <p>
	...
	@VTID(11)
	java.lang.String condition(java.lang.String name, boolean isUserCondition);
	...
	// = 0x5. The runtime will prefer the VTID if present
	@VTID(12)
	void condition(java.lang.String name, boolean isUserCondition,
	...
	@VTID(13)
	void deleteCondition(java.lang.String name, boolean isUserCondition);
	...
	@VTID(15)
	com.gc.IList itemList(@Optional @DefaultValue("0") boolean getRealNames);
