...
public interface ISupportTestParameters extends Com4jObject {
	 ...
	 * </p>
	 * 
	 * @return Returns a value of type com.gc.ITestParameterFactory
	 */

	@DISPID(1)
	// = 0x1. The runtime will prefer the VTID if present
	@VTID(7)
	com.gc.ITestParameterFactory testParameterFactory();

	/**
	 * <p>
	 * For HP use. This property returns true if entity supports test
	 * parameters.
	 * </p>
	 * 
