...
/**
 * Customization services, such as adding users to user groups, maintaining
 * user-defined fields, configuring user access privileges.
 */
@IID("{536BFB95-44A6-4EA2-887D-B7AF28E45A57}")
public interface ICustomization4 extends com.gc.ICustomization3 {
	// Methods:
	/**
	 * <p>
	 ...
	 * </p>
	 * 
	 * @return Returns a value of type com.gc.ICustomizationEntityAttributes
	 */

	@DISPID(22)
	// = 0x16. The runtime will prefer the VTID if present
	@VTID(28)
	com.gc.ICustomizationEntityAttributes entityAttributes();
	 ...
	 * </p>
	 * 
	 * @return Returns a value of type com.gc.ICustomizationRelations
	 */

	@DISPID(23)
	// = 0x17. The runtime will prefer the VTID if present
	@VTID(29)
	com.gc.ICustomizationRelations relations();
	...
	@VTID(31)
	com.gc.IList supportsMultivalueEntitiesTables();
	...
	/**
	 * <p>
	 * For HP use. Returns names of the entities' tables that support QPM KPI
	 * TYPE creation.
	 * </p>
	 * <p>
	...
	@VTID(32)
	com.gc.IList supportsQPMKPITypesEntitiesTables();
	...
	@VTID(33)
	com.gc.IList supportsHistoryEntitiesTables();
	...
	@VTID(34)
	com.gc.IList supportWorkflowEntitiesTables();
	 ...
	 * </p>
	 * 
	 * @return Returns a value of type com.gc.ICustomizationUser
	 */

	@DISPID(31)
	// = 0x1f. The runtime will prefer the VTID if present
	@VTID(37)
	com.gc.ICustomizationUser loggedInUser();
	...
	@VTID(38)
	com.gc.IList supportsDataHidingFilterEntitiesTables();
