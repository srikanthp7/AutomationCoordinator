...
public interface ITDConnection5 extends com.gc.ITDConnection4 {
	// Methods:
	/**
	 * <p>
	...
	@VTID(155)
	void purgeRuns2(java.lang.String testSetFilter, java.lang.String runFilter,
			int keepLast,
	...
	@VTID(157)
	com.gc.IList getLinkedProjects(java.lang.String domainName,
			java.lang.String projectName, java.lang.String linkType);
	...
	/**
	 * <p>
	 * For HP use. Confirms that the user is authorized to use Quality Center
	 * using LWSSO token. If authorized, the user is logged in and can connect
	 * to projects.
	 * </p>
	 * 
	 * @param token
	...
	@VTID(186)
	void loginWithAuthenticationToken(java.lang.String token);
	 ...
	 * <p>
	 * For HP use. Confirms that the user is authorized to use Quality Center.
	 * If authorized, the user is logged in and can connect to projects. Return
	 * the list of project descriptors under all domains that the current logged
	 * in user is allowed to connect to.
	 * </p>
	 * 
	 * @param userName
	 *            Mandatory java.lang.String parameter.
	...
	@VTID(190)
	com.gc.IList loginEx(java.lang.String userName, java.lang.String password);
	...
	/**
	 * <p>
	 * For HP use. Get server address - try to get DNS name if DNS name can't be
	 * reach then return IP address
	 * </p>
	 * <p>
	 ...
	 * </p>
	 * 
	 * @return Returns a value of type com.gc.IProjectDescriptor
	 */

	@DISPID(189)
	// = 0xbd. The runtime will prefer the VTID if present
	@VTID(194)
	com.gc.IProjectDescriptor connectedProjectDescriptor();
	 ...
	 * "ReportToReportProjectTemplateLinkFactory"
	 * </p>
	 * 
	 * @return Returns a value of type com4j.Com4jObject
	 */
	...
	/**
	 * <p>
	 * For HP use. Disconnect locally. Use this method in order to disconnect a
	 * client without sending a disconnect request to the server
	 * </p>
	 */
