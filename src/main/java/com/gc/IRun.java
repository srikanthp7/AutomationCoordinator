...
public interface IRun extends com.gc.IBaseFieldEx {
	// Methods:
	/**
	 * <p>
	...
	/**
	 * <p>
	 * Copies all run execution steps, including new added steps, into the
	 * design steps of the corresponding planning test.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Updates the texts of the run's steps by resolving the parameter values at
	 * run time.
	 * </p>
	 * 
	 * @param updateLocalCache
