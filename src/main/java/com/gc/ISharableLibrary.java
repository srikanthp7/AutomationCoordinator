...
public interface ISharableLibrary extends Com4jObject {
	...
	/**
	 * <p>
	 * Returns an IList of ILibraryInfo references of libraries that are using
	 * this library. The list is empty if none.
	 * </p>
	 * <p>
	...
	@VTID(8)
	com.gc.ILibraryOperationResult importLibraryVerification(
			java.lang.String dstDomainName, java.lang.String dstProjectName,
			int srcBaselineId);
