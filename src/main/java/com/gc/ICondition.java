...
public interface ICondition extends Com4jObject {
	...
	/**
	 * <p>
	 * For HP use. The condition type: TDCOND_RUN for a test run status, or any
	 * other value for a time condition.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * For a run condition, the source condition ID. For a time condition, a
	 * date-time string.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * For HP use. For a run condition, the source test instance number of the
	 * condition.
	 * </p>
	 * <p>
