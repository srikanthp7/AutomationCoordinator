...
public interface IVCS extends Com4jObject {
	 ...
	 * 
	 * @param ignored
	 *            Optional parameter. Default value is "1.1.1"
	 * @param comments
	...
	/**
	 * <p>
	 * For HP use. Generally unnecessary as Test deletion covers this
	 * functionality. Deletes the object from the Version Control database.
	 * </p>
	 */
	...
	@VTID(12)
	void checkOut(java.lang.String version, java.lang.String comment,
			boolean ignored, @Optional @DefaultValue("0") boolean readOnly,
	...
	@VTID(13)
	void checkIn(java.lang.String ignored, java.lang.String comments,
			@Optional @DefaultValue("-1") boolean ignored1,
			@Optional @DefaultValue("-1") boolean ignored2);

	/**
	 * <p>
	 * [DEPRECATED]For HP use. This method is potentially destructive. Use only
	 * if necessary and with care. Sets the VCS object current version.
	 * </p>
	 * 
	 * @param version
	 *            Mandatory java.lang.String parameter.
	...
	/**
	 * <p>
	 * For HP use. Changes VCS object status from GET to CHECK-OUT. The object
	 * must be in a GET status to use this method.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Undoes the check out operation, falling back to the current version on
	 * the server.
	 * </p>
	 * 
	 * @param ignored
	...
	/**
	 * <p>
	 * A reference to a VersionItem object, containing the checkout information
	...
	/**
	 * <p>
	 * For HP use. Returns a list of references to the VersionItem objects of
	 * this entity.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * A reference to a VersionItem object containing information about a
	 * specific version, specified by the Version argument.
	 * </p>
	 * <p>
	...
	@VTID(22)
	void viewVersion(java.lang.String bstrVersion,
	...
	@VTID(23)
	void clearView(@Optional @DefaultValue("") java.lang.String bstrVersion);

	/**
	 * <p>
	 * A list of IVersionItem references for accessing the details of each
	...
	/**
	 * <p>
	 * Refreshes the VCS object from the server to the client, overwriting
	 * values in memory.
	 * </p>
	 */
	...
	@VTID(26)
	void checkInEx(java.lang.String ignored, java.lang.String comments,
			@Optional @DefaultValue("-1") boolean ignored1,
			@Optional @DefaultValue("-1") boolean ignored2,
