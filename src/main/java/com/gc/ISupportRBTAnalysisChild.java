 ...
 * coclass. This class provides services for handling the child requirements
...
public interface ISupportRBTAnalysisChild extends Com4jObject {
	...
	/**
	 * <p>
	 * The testing level determined by the last analysis, from 'RBT Testing
	 * Levels' in LISTS.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Should this requirement be excluded in Risk-based Quality Management
	 * analysis?
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * The parent requirement for the current Risk-based Quality Management
	 * Analysis.
	 * </p>
	 * <p>
