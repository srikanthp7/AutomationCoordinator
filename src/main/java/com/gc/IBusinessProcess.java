...
public interface IBusinessProcess extends com.gc.ITest {
	// Methods:
	/**
	 * <p>
	 * Deprecated. Use factories to load BusinessProcess object and all of its
	 * dependencies. Loads the BusinessProcess object and all of its
	...
	/**
	 * <p>
	 * Deprecated. Use factories to save the BusinessProcess object and all of
	 * its dependencies. Saves the BusinessProcess object and all of its
	 * dependencies.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Deprecated. Use TestParameterFactory of ISupportTestParameters. The list
	 * of run time parameters for the test.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Deprecated. Use TestParameterFactory of ISupportTestParameters. Adds a
	 * runtime parameter to the test.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Deprecated. Use TestParameterFactory of ISupportTestParameters. Delete
	 * the given RTParam from the test.
	 * </p>
	 * 
	 * @param pRTParam
	...
	/**
	 * <p>
	 * Deprecated. Use BPComponentFactory of IBusinessProcess4. The list of
	 * BPComponents that belong to the test.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Deprecated. Use BPComponentFactory of IBusinessProcess4. Adds the
	 * specified Component to the test.
	 * </p>
	 * 
	 * @param pComponent
	 *            Mandatory com4j.Com4jObject parameter.
	...
	/**
	 * <p>
	 * Deprecated. Use BPComponentFactory of IBusinessProcess4. Delete the
	 * specified BPComponent from the test.
	 * </p>
	 * 
	 * @param pBPComponent
	 *            Mandatory com4j.Com4jObject parameter.
	...
	/**
	 * <p>
	 * Deprecated. Use BPComponentFactory of IBusinessProcess4 (Group is
	 * BPComponent). Adds an empty group of components to the test.
	 * </p>
	 * 
	 * @return Returns a value of type com4j.Com4jObject
	 */
	 ...
	 * <p>
	 * Deprecated. Use BPComponentFactory of IBusinessProcess4 (Group is
	 * BPComponent). Delete the specified BPGroup from the test.
	 * </p>
	 * 
	 * @param pBPGroup
	 *            Mandatory com4j.Com4jObject parameter.
	...
	@VTID(57)
	void deleteGroup(@MarshalAs(NativeType.Dispatch) com4j.Com4jObject pBPGroup);

	/**
	 * <p>
	 * Deprecated. Use BPComponentFactory of IBusinessProcess4 (Group is
	 * BPComponent). Gets a BPGroup from the test by its ID.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Download the snapshots attached to the components of the test to the
	 * clients cache.
	 * </p>
	 */
	...
	@VTID(60)
	void downloadPicturesProgress(Holder<Integer> total, Holder<Integer> current);
	...
	/**
	 * <p>
	 * Deprecated. Use BPComponentFactory of IBusinessProcess4. Gets a
	 * BPComponent from the test by its ID.
	 * </p>
	 * <p>
