...
public interface IAlertable2Dispatch extends Com4jObject {
	...
	/**
	 * <p>
	 * Removes an alert or alerts associated with the current object from the
	 * database.
	 * </p>
	 * 
	 * @param iDs
	...
	@VTID(7)
	void deleteAlert(@MarshalAs(NativeType.VARIANT) java.lang.Object iDs);
	...
	@VTID(10)
	com.gc.IList getAlertList(@Optional @DefaultValue("0") boolean needRefresh);
	...
	com4j.Com4jObject addAlert(java.lang.String changedEntityType,
			int changedEntityID, java.lang.String alertSubject,
