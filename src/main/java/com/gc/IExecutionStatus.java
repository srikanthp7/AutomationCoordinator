...
/**
 * Represents the execution status of the scheduler. The user can scan through
 * each test in the scheduler.
 */
...
public interface IExecutionStatus extends Com4jObject, Iterable<Com4jObject> {
	...
	/**
	 * <p>
	 * Gets an ATL.IEnumOnSTLImpl enumerator for the TestExecStatus objects. For
	 * information on the ATL Class and IEnumOnSTLImpl, see Microsoft
	 * documentation.
	 * </p>
	 * <p>
