...
public interface ITest extends com.gc.IBaseFieldExMail {
	// Methods:
	/**
	 * <p>
	...
	/**
	 * <p>
	 * Adds the specified requirement to the list of requirements covered by
	 * this test.
	 * </p>
	 * 
	 * @param req
	...
	@VTID(31)
	int coverRequirement(@MarshalAs(NativeType.VARIANT) java.lang.Object req,
			int order, boolean recursive);
	...
	@VTID(32)
	void removeCoverage(@MarshalAs(NativeType.VARIANT) java.lang.Object req);
	...
	/**
	 * <p>
	 * Deprecated. Use TestParameterFactory of ISupportTestParameters. The
	...
	/**
	 * <p>
	 * For HP use. Indicates whether to ignore hidden user group data when
	 * retrieving tests from the server.
	 * </p>
	 * <p>
