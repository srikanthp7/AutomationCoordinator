...
/**
 * A collection of CustomizationTransitionRule objects applied to a specific
 * field and user group.
 */
...
public interface ICustomizationTransitionRules extends Com4jObject {
	...
	/**
	 * <p>
	 * The number of CustomizationTransitionRule objects contained by the
	 * current object.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * The CustomizationTransitionRule specified by its position in the list of
	 * transition rules.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Indicates if the object has been modified since the last synchronization
	 * with database.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * The CustomizationField object to which the transition rules in the
	 * current object are attached.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * The CustomizationUsersGroup object to which the transition rules in the
	 * current object are attached.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * The location (database table) of the field to which the transition rules
	 * in the current object are attached.
	 * </p>
	 * <p>
