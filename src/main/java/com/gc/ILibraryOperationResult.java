...
/**
 * For HP use. Represents a verification operation result for a library
 * operation (like import, sync, create baseline, etc).
 */
...
public interface ILibraryOperationResult extends Com4jObject {
	 ...
	 * Now it is single file - result of Broken Links verification.
	 * </p>
	 * <p>
