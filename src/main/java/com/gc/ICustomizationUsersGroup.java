...
public interface ICustomizationUsersGroup extends Com4jObject {
	...
	@VTID(11)
	void addUser(@MarshalAs(NativeType.VARIANT) java.lang.Object user);
	...
	@VTID(12)
	void removeUser(@MarshalAs(NativeType.VARIANT) java.lang.Object user);
	...
	/**
	 * <p>
	 * Indicates if the object has been modified since being downloaded from
	 * database.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * If true, the object is marked for deletion, but the deletion has not been
	 * committed.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * The data hiding filter for the entity specified by the FilterType
	 * parameter.
	 * </p>
	 * <p>
	...
	@VTID(19)
	java.lang.String hideFilter(java.lang.String filterType);
	...
	// = 0xa. The runtime will prefer the VTID if present
	@VTID(20)
	void hideFilter(java.lang.String filterType, java.lang.String pVal);
