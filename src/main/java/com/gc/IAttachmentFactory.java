...
public interface IAttachmentFactory extends com.gc.IBaseFactory {
	// Methods:
	/**
	 * <p>
	 * Deprecated. Use the entity-level Attachments property for downloading and
	...
	@VTID(17)
	void factoryProperties(Holder<java.lang.String> ownerType,
