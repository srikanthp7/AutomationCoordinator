...
public interface ITDConnection4 extends com.gc.ITDConnection3 {
	// Methods:
	/**
	 * <p>
	...
	/**
	 * <p>
	 * Deprecated. To obtain root factory, use analysis segment's root folder's
	 * factory.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Takes a simple text message and sends it as an HTML Mail using the
	 * Quality Center format.
	 * </p>
	 * 
	 * @param sendTo
	 *            Mandatory java.lang.String parameter.
	...
	@VTID(146)
	com.gc.IList getAllVisibleProjectDescriptors();
	...
	/**
	 * <p>
	 * Refreshes the connection state: updates the Connected, LoggedIn, and
	 * ProjectConnected properties.
	 * </p>
	 */
	...
	@VTID(149)
	void clientVersion(java.lang.String newVal,
