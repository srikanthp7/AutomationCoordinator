...
public interface IImport extends Com4jObject {
	...
	@VTID(7)
	@ReturnValue(index = 0)
	java.lang.String getColumnNames(java.lang.String bstrResourceeName);
	...
	@VTID(8)
	void importData(java.lang.String bstrColumnNames,
