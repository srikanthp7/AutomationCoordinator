...
public interface ISupportCopyPaste3 extends Com4jObject {
	...
	@VTID(7)
	void pasteFromClipBoard(java.lang.String clipboardData,
	...
	@VTID(8)
	java.lang.String copyToClipBoard(java.lang.String idsFilter,
			@Optional @DefaultValue("0") int mode,
			@Optional @DefaultValue("") java.lang.String path);

	/**
	 * <p>
	 * Checks if the paste target is in the same project from which the material
	 * was copied.
	 * </p>
	 * <p>
