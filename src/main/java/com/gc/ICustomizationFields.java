...
public interface ICustomizationFields extends Com4jObject {
	...
	/**
	 * <p>
	 * The customization field object for the specified database table and
	 * field.
	 * </p>
	 * <p>
	...
	com4j.Com4jObject field(java.lang.String tableName,
	...
	@VTID(8)
	com.gc.IList fields(@Optional @DefaultValue("") java.lang.String tableName);

	/**
	 * <p>
	 * Finds the first free, inactive field in the specified table, signs the
	 * field as active, and returns the CustomizationFields object representing
	 * the field.
	 * </p>
	 * 
	 * @param tableName
