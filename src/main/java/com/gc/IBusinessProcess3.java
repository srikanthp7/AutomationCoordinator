...
public interface IBusinessProcess3 extends com.gc.IBusinessProcess2 {
	// Methods:
	/**
	 * <p>
	 * Adds an alert to all tests that contain components that represent the
	 * same screen as any of the components in which a change is detected.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Deletes any change detection alert that is active for the Business
	 * Process.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * For HP use. Get the IComponent that represents the component of this
	 * Flow.
	 * </p>
	 * 
