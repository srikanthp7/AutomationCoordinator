...
/**
 * A collection of Customization types of a specific entity. For example, the
 * types of the requirement entity.
 */
...
public interface ICustomizationTypes extends Com4jObject {
	...
	com4j.Com4jObject addCustomizationType(int entityType,
			java.lang.String name, int createAsTypeId);

	/**
	 * <p>
	 * Removes the CustomizationType with the specified ID from the specified
	 * entity.
	 * </p>
	 * 
	 * @param entityType
	 *            Mandatory int parameter.
	 * @param customizationTypeId
	 *            Mandatory int parameter.
	 */
	...
	@VTID(9)
	com.gc.IList getEntityCustomizationTypes(int entityType);
	...
	@VTID(11)
	com.gc.IList getEntityCustomizationSubtypes(java.lang.String entityType);
	...
	com4j.Com4jObject getEntityCustomizationSubtype(
			java.lang.String entityType, java.lang.String customizationSubtypeId);
