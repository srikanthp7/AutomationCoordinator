...
/**
 * Services to create and maintains lists within entity factories. Use any
 * factory object to create any number of list instances for objects in the
 * factory.
 */
@IID("{68FE31A3-6242-4AA4-9BBE-D0715F810DB3}")
public interface IFactoryList extends com.gc.IList {
	// Methods:
	/**
	 * <p>
	...
	/**
	 * <p>
	 * Reads saved list filter and data for all listed objects, overwriting
	 * values in memory.
	 * </p>
	 */
