...
public interface IFacet extends com.gc.IBaseFieldEx {
	// Methods:
	/**
	 * <p>
	...
	/**
	 * <p>
	 * For HP use. The Manual Steps Factory for this facet while indicating if
	 * the factory is created directly from component.
	 * </p>
	 * 
	 * @param bIsCreatedDirectlyFromComponent
