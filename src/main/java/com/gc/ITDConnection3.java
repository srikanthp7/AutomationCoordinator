...
public interface ITDConnection3 extends com.gc.ITDConnection2 {
	// Methods:
	/**
	 * <p>
	 * For HP use. GetNonce.
	...
	@VTID(99)
	com.gc.IList getExtensions(int mode);
	...
	com4j.Com4jObject extensionFactory(GUID lpclsid);
	...
	/**
	 * <p>
	 * The application entity tree and related application entity folders
