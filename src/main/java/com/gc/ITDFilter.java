...
public interface ITDFilter extends Com4jObject {
	...
	/**
	 * <p>
	 * Reads saved data and refreshes the fetched list according to the current
	 * filter, overwriting values in memory.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Indicates if the filter for the specified field is case sensitive. The
	 * default is False.
	 * </p>
	 * <p>
