...
public interface IReq3 extends com.gc.IReq2 {
	// Methods:
	/**
	 * <p>
	 * For HP use.
	...
	com.gc.IList getLinkedEntities(
			com.gc.ITraceabilityMatrixRelationSettings settings,
			Holder<java.lang.String> tableName);

	/**
	 * <p>
	 * Returns the list of test configurations that cover the current
	 * requirement and, optionally, cover those of its children that match the
	 * requirement filter.
	 * </p>
	 * 
	 * @param recursive
	...
	@VTID(67)
	com.gc.IList getCoverageTestConfigs(
			@Optional @DefaultValue("0") boolean recursive);

	/**
	 * <p>
	 * Returns the list of test configurations that cover the current
	 * requirement with filtered tests, and optionally, cover those of its
	...
	@VTID(68)
	com.gc.IList getCoverageTestConfigsByTestIds(java.lang.String testIDs,
			@Optional @DefaultValue("0") boolean recursive);
