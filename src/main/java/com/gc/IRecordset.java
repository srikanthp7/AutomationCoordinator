...
/**
 * Represents the entire set of records resulting from an executed command. At
 * any given time, the Recordset object refers to a single record within the
 * record set as the current record.
 */
@IID("{025854DA-9D81-40E8-853D-F4EA33073A77}")
public interface IRecordset extends com.gc.IColumnInfo {
	// Methods:
	/**
	 * <p>
	...
	@VTID(13)
	@DefaultMethod
	void fieldValue(@MarshalAs(NativeType.VARIANT) java.lang.Object fieldKey,
	...
	@VTID(26)
	void refresh(@Optional @DefaultValue("0") int range, @Optional int low,
			@Optional int high);
