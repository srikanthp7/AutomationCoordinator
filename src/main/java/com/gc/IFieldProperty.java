...
public interface IFieldProperty extends Com4jObject {
	...
	/**
	 * <p>
	 * Checks if e-mail is sent to the users on the notification list when this
	 * field changes.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Checks if the field saves the Tree Node ID (True), or the passed value
	 * (False).
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Checks if the user currently logged on the TDConnection is permitted to
	 * modify this field.
	 * </p>
	 * <p>
