...
public interface IOnExecEventSchedulerRestartParams extends
		com.gc.IOnExecEventSchedulerActionParams {
	// Methods:
	/**
	 * <p>
	...
	@VTID(12)
	void cleanupTest(@MarshalAs(NativeType.VARIANT) java.lang.Object vVal);
