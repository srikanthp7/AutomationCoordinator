...
public interface IBusinessProcess4 extends com.gc.IBusinessProcess3 {
	// Methods:
	/**
	 * <p>
	...
	/**
	 * <p>
	 * The Last Update Timestamp for this Business Process Test. according to
	 * specified componentFieldName
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * For HP use. Checks if all the components in the test support QTP
	 * automation.Returns false if there are no components in the test.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * For HP use. For each test parameter get a list of bp iter param ids
	 * promoted to it
	 * </p>
	 * 
	 * @param testParamIdsList
	...
	@VTID(83)
	com.gc.IList getBPIterParamsUsingTestParameters(
			com.gc.IList testParamIdsList);
