...
public interface _ISubjectNode3 extends Com4jObject {
	...
	/**
	 * <p>
	 * Checks if the item has been modified since last refresh or post
	 * operation. If true, the field properties on the server side are not up to
	 * date.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Indicates whether to make the item changeable to other users
	 * automatically after a Refresh or Post.
	 * </p>
	 * <p>
	...
	@VTID(7)
	void post(@Optional @DefaultValue("-1") boolean undoOnFailure);

	/**
	 * <p>
	 * Indicates whether the given field is modified, optionally returning the
	...
	/**
	 * <p>
	 * Verifies if the given value can be put in the given field. The checks are
	 * local, i.e. no round trips are made.
	 * </p>
	 * 
	 * @param fieldName
	 *            Mandatory java.lang.String parameter.
	 ...
	 * @return Returns a value of type com.gc.ISysTreeNode
	 */

	@VTID(11)
	com.gc.ISysTreeNode addNode(java.lang.String name,
			java.lang.String description, int viewOrder);

	/**
	 * <p>
	 * Finds node children matching the name exactly according to specified
	 * search pattern.
	 * </p>
	 * 
	 * @param pattern
	...
	@VTID(12)
	com.gc.IList findChildrenExact(java.lang.String pattern,
