...
/**
 * For HP use. Represents a Quality Center module, such as Requirements,
 * Defects, TestPlan, and so on.
 */
...
public interface IModule extends Com4jObject {
	...
	// = 0x4. The runtime will prefer the VTID if present
	@VTID(13)
	void guid(java.lang.String pVal);

	/**
	 * <p>
	 * A bit-mask string that indicates for which groups the module is visible
	...
	// = 0x5. The runtime will prefer the VTID if present
	@VTID(15)
	void visible(java.lang.String pVal);
