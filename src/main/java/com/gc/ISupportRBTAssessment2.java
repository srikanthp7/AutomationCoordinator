...
public interface ISupportRBTAssessment2 extends com.gc.ISupportRBTAssessment {
	// Methods:
	/**
	 * <p>
	 * The chosen value to this Functional Complexity criterion for this
	 * requirement.
	 * </p>
	 * <p>
	...
	// = 0x11. The runtime will prefer the VTID if present
	@VTID(26)
	void fcChosenAnswerForQuestion(int questionID, int pAnswerID);

	/**
	 * <p>
	 * Assess the Functional Complexity risk level for this requirement,
	...
	/**
	 * <p>
	 * Functional Complexity risk level for this requirement, from the last time
	...
	// = 0x15. The runtime will prefer the VTID if present
	@VTID(32)
	void customFCLevel(java.lang.String pVal);
	...
	// = 0x19. The runtime will prefer the VTID if present
	@VTID(38)
	void customRiskLevel(java.lang.String pVal);
