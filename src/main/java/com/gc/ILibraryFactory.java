...
public interface ILibraryFactory extends com.gc.IBaseFactoryEx {
	// Methods:
	/**
	 * <p>
	 * Add a new Imported Library Item. This will create the item and
	 * pre-connect it to the 'Created From' Library. Note: A valid folder id
	 * must be passed in ItemData if this factory was retrieved from the
	 * connection.
	 * </p>
	 * 
	 * @param domain
	...
	com4j.Com4jObject addImportedItem(java.lang.String domain,
			java.lang.String project, java.lang.String libraryName,
			int libraryID, java.lang.String baselineName, int baselineId,
			@Optional @MarshalAs(NativeType.VARIANT) java.lang.Object itemData);

	/**
	 * <p>
	 * Returns the list of the entities' table names which can be a library
	 * part.
	 * </p>
	 * <p>
	...
	@VTID(18)
	com.gc.IList libraryPartsEntitiesTables();
