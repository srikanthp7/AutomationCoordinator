...
public interface ICustomizationField2 extends com.gc.ICustomizationField {
	// Methods:
	/**
	 * <p>
	 * Indicates whether members of the group can change the value of this
	 * field.
	 * </p>
	 * <p>
	...
	@VTID(75)
	com.gc.IList authorizedModifyForGroups();
	...
	/**
	 * <p>
	 * Indicates whether the field can be modified by the owner if the owner
	...
	/**
	 * <p>
	 * The list of CustomizationUsersGroup objects of the groups for which only
	 * the owner can modify the field.
	 * </p>
	 * <p>
	...
	@VTID(78)
	com.gc.IList authorizedOwnerSensibleForGroups();
	...
	/**
	 * <p>
	 * Indicates whether the field is visible to the specified group in the new
	 * defect dialog.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * The list of CustomizationUsersGroup objects of the groups for which the
	 * field is visible in the new defect dialog.
	 * </p>
	 * <p>
	...
	@VTID(81)
	com.gc.IList authorizedVisibleInNewBugForGroups();
	...
	/**
	 * <p>
	 * Indicates whether the field is visible in the New Defect dialog to the
	 * specified group.
	 * </p>
	 * <p>
	...
	// = 0x29. The runtime will prefer the VTID if present
	@VTID(83)
	void visibleForGroup(@MarshalAs(NativeType.VARIANT) java.lang.Object group,
			boolean pGrant);

	/**
	 * <p>
	 * The list of CustomizationUsersGroup objects of the groups for which the
	 * field is visible in customization dialogs.
	 * </p>
	 * <p>
	...
	@VTID(84)
	com.gc.IList authorizedVisibleForGroups();
	...
	/**
	 * <p>
	 * Indicates if items of this type can form groups with others of the same
	 * type.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * For future use. Indicates whether history is kept for changes to the
	 * field.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Indicates whether the content of the field is searched by the Search
	 * method.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Checks if the field has a physical representation in the database. If
	 * True, there is no physical representation.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Checks if the field can be configured to store multiple values. If False,
	 * IsMultiValue cannot be set to True.
	 * </p>
	 * <p>
