...
public interface ISysTreeNode extends Com4jObject {
	...
	@VTID(9)
	com.gc.ISysTreeNode addNode(java.lang.String nodeName);
	...
	@VTID(13)
	com.gc.ISysTreeNode findChildNode(java.lang.String childName);
	...
	@VTID(14)
	void removeNode(@MarshalAs(NativeType.VARIANT) java.lang.Object node);
	...
	@VTID(16)
	com.gc.ISysTreeNode child(int index);
	...
	@VTID(19)
	com.gc.IList findChildren(java.lang.String pattern,
