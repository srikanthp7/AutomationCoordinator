...
public interface ITDConnection9 extends com.gc.ITDConnection8 {
	// Methods:
	/**
	 * <p>
	...
	/**
	 * <p>
	 * Creates application session on server, similar to login operation but for
	 * SSO configuration.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * For HP use. Establishes application session on the server in SSO env.
	 * Returns the list of project descriptors visible to the authenticating
	 * user.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Apply client certificate to connection, the parameter should be valid
	...
	@VTID(223)
	void setExecutionMode(com.gc.TDAPI_EXECUTION_MODES executionMode);
