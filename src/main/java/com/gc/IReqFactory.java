...
public interface IReqFactory extends com.gc.IBaseFactoryEx {
	// Methods:
	/**
	 * <p>
	...
	@VTID(17)
	com.gc.IList getChildrenList(int fatherID);

	/**
	 * <p>
	 * Gets a list of requirements containing the Pattern value in specified
	 * field.
	 * </p>
	 * 
	 * @param startRootID
	...
	@VTID(18)
	com.gc.IList find(int startRootID, java.lang.String fieldName,
			java.lang.String pattern, @Optional @DefaultValue("0") int mode,
	...
	/**
	 * <p>
	 * Builds Req summary graph. Extends BuildSummaryGraph with ability to
	 * display Null parent folders.
	 * </p>
	 * 
	 * @param xAxisField
	 *            Optional parameter. Default value is ""
	...
	/**
	 * <p>
	 * Builds Requirement progress graph. Extends BuildProgressGraph with
	 * ability to display Null parent folders.
	 * </p>
	 * 
	 * @param groupByField
	 *            Optional parameter. Default value is ""
