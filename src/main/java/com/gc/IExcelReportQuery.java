...
public interface IExcelReportQuery extends Com4jObject {
	...
	/**
	 * <p>
	 * Executes the query. Returns the limit status (limit not reached or the
	 * kind of limit that was reached).
	 * </p>
	 * 
	 * @param limit
	...
	com4j.Com4jObject execute(int limit, Holder<Integer> pintTruncationStatus,
