...
public interface ICustomizationField extends Com4jObject {
	...
	/**
	 * <p>
	 * Indicates if the field is active. Inactive user-defined fields are not
	...
	/**
	 * <p>
	 * Indicates if Users on the list to be notified of changes are notified
	...
	/**
	 * <p>
	 * Indicates if the field stores the Tree Node ID, rather than the passed
	 * value.
	 * </p>
	 * <p>
	...
	// = 0x16. The runtime will prefer the VTID if present
	@VTID(48)
	void list(@MarshalAs(NativeType.Dispatch) com4j.Com4jObject pVal);

	/**
	 * <p>
	 * If the field contains a list, the ID of the list root node. If not,
	 * RootId is NULL.
	 * </p>
	 * <p>
	...
	// = 0x17. The runtime will prefer the VTID if present
	@VTID(50)
	void rootId(@MarshalAs(NativeType.VARIANT) java.lang.Object pVal);
	...
	/**
	 * <p>
	 * Indicates if the object has been modified since the last download from
	 * the server.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * The bit mask that indicates for which groups this field can be modified
	 * only by its owner.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Indicates if the field is visible for the specified groups in a new
	 * defect form.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * For HP use. Indicates if a summation of the field can be obtained for
	 * graph presentation.
	 * </p>
	 * <p>
