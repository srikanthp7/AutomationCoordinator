...
/**
 * Services to perform customization tasks, such as adding users to user groups,
 * defining user-defined fields, and defining user access privileges.
 */
@IID("{9D4F53EF-41A2-4059-8AB3-13BBCA8333E8}")
public interface ICustomization extends com.gc.IObjectLockingSupport {
	// Methods:
	/**
	 * <p>
	 * Loads all customization data from the server into the client cache. This
	 * includes actions, fields, lists, modules, permissions, users, and user
	 * groups.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Checks if the program can use the maximum allowable user-defined fields
	 * (99 user-defined fields and 3 memo fields).
	 * </p>
	 * <p>
