...
/**
 * An association between a CustomizationField and an object of a class that
 * implements ICustomizationType.
 */
...
public interface ICustomizationTypedField extends Com4jObject {
	...
	/**
	 * <p>
	 * Returns a reference to the CustomizationSubtype associated with this
	 * object.
	 * </p>
	 * <p>
