...
public interface _IPerformanceMonitorHelper extends Com4jObject {
	// Methods:
	/**
	 * @param pPerformanceMonitor
	 *            Mandatory com4j.Com4jObject parameter.
	 */

	@VTID(3)
	void setPerformanceMonitor(com4j.Com4jObject pPerformanceMonitor);
	...
	@VTID(4)
	java.lang.String updateClientPerformanceData(java.lang.String requestData);
