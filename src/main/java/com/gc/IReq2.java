...
public interface IReq2 extends com.gc.IReq {
	// Methods:
	/**
	 * <p>
	 * The requirement link factory that manages the traceability links of the
	 * current requirement to its associated requirements in the specified
	 * direction.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Checks if the current requirement has at least one associated requirement
	...
	/**
	 * <p>
	 * Assigns the target cycle of the requirement as the target cycle of all
	 * child requirements, recursively down the folder tree.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Assigns the target release of the requirement as the target release of
	 * all child requirements, recursively down the folder tree.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Returns the list of tests that cover the current requirement and,
	 * optionally, cover those of its children that match the requirement
	 * filter.
	 * </p>
	 * 
	 * @param reqFilter
