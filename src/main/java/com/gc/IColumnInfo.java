...
public interface IColumnInfo extends Com4jObject {
	...
	/**
	 * <p>
	 * The physical size as defined in the database of the fields in the column
	 * specified by Index (zero-based).
	 * </p>
	 * <p>
	...
	@VTID(10)
	java.lang.String colName(int index);

	/**
	 * <p>
	 * Gets the index (zero-based) of a Recordset column specified by column
	 * name.
	 * </p>
	 * <p>
	...
	@VTID(11)
	int colIndex(java.lang.String name);
