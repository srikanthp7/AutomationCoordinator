...
public interface ICustomizationRBT extends Com4jObject {
	...
	/**
	 * <p>
	 * The lower threshold of Risk assessment for each Business Criticality
	 * level.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * The lower threshold of Risk assessment for each Failure Probability
	 * level.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Indicates if the Risk-based Quality Management Customization has been
	 * modified since the last synchronization with the database.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Translate Failure Probability from TDAPI_RBT_FP_LEVELS to its name in the
	 * database.
	 * </p>
	 * 
	 * @param fpLevelEnum
	...
	/**
	 * <p>
	 * Translate Business Criticality from TDAPI_RBT_BI_LEVELS to its name in
	 * the database.
	 * </p>
	 * 
	 * @param biLevelEnum
	...
	/**
	 * <p>
	 * Calculate the Business Criticality level from the sum of all the values'
	 * weights.
	 * </p>
	 * 
	 * @param answersWeight
	...
	/**
	 * <p>
	 * Calculates the Failure Probability level from the sum of all the values'
	 * weights.
	 * </p>
	 * 
	 * @param answersWeight
