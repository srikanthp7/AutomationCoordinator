...
/**
 * For HP use. Manages the system cache in conjunction with the ExtendedStorage
 * objects.
 */
...
public interface ICacheMgr extends Com4jObject {
	...
	/**
	 * <p>
	 * Use the date of download from the server instead of the access date when
	 * determining older files for deletion.
	 * </p>
	 * 
	 * @param bsFilePath
