...
/**
 * Deprecated. Use ITestLabFolderFactory. Manages the test set tree and its
 * related test set folders.
 */
...
public interface ITestSetTreeManager extends Com4jObject {
	...
	/**
	 * <p>
	 * Gets the test set tree node object corresponding to the specified node
	 * ID.
	 * </p>
	 * <p>
