...
/**
 * Represents a single transition rule. A transition rule allows a change in
 * value from a given source value to a given destination value.
 */
...
public interface ICustomizationTransitionRule extends Com4jObject {
	...
	/**
	 * <p>
	 * The source value of the transition rule, that is, the value before the
	 * change.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * The destination value of the transition rule, that is, the value after
	 * the change.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * For HP use. The action defined in the DestinationValue and SourceValue
