...
public interface IVersionedEntitiesFactory extends Com4jObject {
	...
	/**
	 * <p>
	 * For HP use. Returns the specified version of the item. Applies only to
	 * the Test entity.
	 * </p>
	 * 
	 * @param itemKey
	...
	/**
	 * <p>
	 * Returns the number of entities of the type managed by this factory that
	 * are checked out by the current user.
	 * </p>
	 * <p>
	...
	@VTID(9)
	void checkInEntities(com.gc.IList pList, java.lang.String comments);
	...
	@VTID(10)
	void checkOutEntities(com.gc.IList pList, java.lang.String comments);
	...
	@VTID(11)
	void undoCheckOutEntities(com.gc.IList pList);
