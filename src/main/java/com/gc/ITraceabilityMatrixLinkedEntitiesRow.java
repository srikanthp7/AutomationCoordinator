...
/**
 * For HP use. Represents traceability matrix row for linked entities of a
 * single entity.
 */
...
public interface ITraceabilityMatrixLinkedEntitiesRow extends Com4jObject {
	...
	/**
	 * <p>
	 * Returns a copy of The list of the traceability matrix linked entities
	 * results, related to the row.
	 * </p>
	 * <p>
