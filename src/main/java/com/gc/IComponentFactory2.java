...
public interface IComponentFactory2 extends com.gc.IComponentFactory {
	// Methods:
	/**
	 * <p>
	...
	@VTID(18)
	java.lang.String convertManualTestToComponent(int destFolderId,
			java.lang.String newComponentName, java.lang.String testIDs,
			int numOfTests);

	/**
	 * <p>
	 * For HP use. Converts all manual tests in a folder or folders to
	 * components.
	 * </p>
	 * 
	 * @param destFolderId
	...
	@VTID(19)
	java.lang.String convertAllManualTestsInFolder(int destFolderId,
			java.lang.String srcFolderIds, int recursive,
			java.lang.String newfolderName, int numOfFolders);
	...
	@VTID(20)
	void mail(@MarshalAs(NativeType.VARIANT) java.lang.Object items,
