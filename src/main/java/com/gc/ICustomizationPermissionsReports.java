...
/**
 * For HP use. Patch interface for skipping permission checking , used for
 * standard reports
 */
...
public interface ICustomizationPermissionsReports extends Com4jObject {
	...
	/**
	 * <p>
	 * For HP use.Force Skip permission check on add item - patch only for
	 * Atlantis for report creation
	 * </p>
	 * 
	 * @param bEnable
