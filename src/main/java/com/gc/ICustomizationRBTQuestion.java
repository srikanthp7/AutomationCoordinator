...
/**
 * A Business Criticality or failure probability criterion, used to assess a
 * risk.
 */
...
public interface ICustomizationRBTQuestion extends Com4jObject {
	...
	/**
	 * <p>
	 * The IList of CustomizationRBTAnswer objects of all possible values for
	 * this criterion, ordered by weight.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Adds a new possible value. Returns the new value as a
