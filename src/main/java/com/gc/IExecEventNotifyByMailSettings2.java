...
/**
 * Represents the notification to be sent by e-mail after a test has completed
 * its run.
 */
@IID("{89309A1B-2F3C-4D13-922D-7BC5D7B6F829}")
public interface IExecEventNotifyByMailSettings2 extends
		com.gc.IExecEventNotifyByMailSettings {
	// Methods:
	/**
	 * <p>
