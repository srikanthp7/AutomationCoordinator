...
public interface ICustomizationMailConditions extends Com4jObject {
	...
	com4j.Com4jObject condition(java.lang.String name, int conditionType);
	...
	@VTID(9)
	@ReturnValue(type = NativeType.Dispatch)
	com4j.Com4jObject addCondition(java.lang.String name, int conditionType,
	...
	@VTID(10)
	void removeCondition(java.lang.String name, int conditionType);
	...
	@VTID(11)
	boolean conditionExist(java.lang.String name, int conditionType);
