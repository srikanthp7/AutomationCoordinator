...
public interface ICustomizationModules2 extends com.gc.ICustomizationModules {
	// Methods:
	/**
	 * <p>
	 * Indicates if the specified module is visible in the UI to the specified
	 * user group.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * The list of the user groups to which the specified module is visible in
	 * the UI.
	 * </p>
	 * <p>
	...
	@VTID(17)
	com.gc.IList visibleForGroups(int moduleID);
