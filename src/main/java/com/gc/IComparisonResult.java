...
public interface IComparisonResult extends Com4jObject {
	...
	/**
	 * <p>
	 * Returns a copy of the Owner Type of the compared element. For example, if
	 * type param is CROS_REF (Attachment), then OwnerType may be REQ, TEST,
	 * DES_STEP, etc.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Returns the first compared element's owner ID. This value exists iff
	 * Owner Type exists.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Returns the second compared element's owner ID. This value exists iff
	 * Owner Type exists.
	 * </p>
	 * <p>
