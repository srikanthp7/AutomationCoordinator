...
/**
 * Represents Risk-based Quality Management analysis capabilities for the Req
 * coclass.
 */
...
public interface ISupportRBTAnalysisParent extends Com4jObject {
	...
	/**
	 * <p>
	 * Do analysis, create analysis results, but do not save testing levels in
	 * children yet.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Do analysis, create analysis results and save testing levels for all
	 * child Req objects.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Use current policy matrix and re-apply it on the aggregated counts matrix
	 * to calculate total analyzed requirements duration.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Calculated time needed to test a requirement in the given Risk and
	 * Functional Complexity, according to the current policy.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Checks whether the parent requirement has valid Risk-based Quality
	 * Management analysis result data.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Time it would take to test the requirements with CustomTestingLevel with
	 * this policy set in the related Risk-based Quality Management Analysis
	 * setup.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Time it would take to test the requirements without CustomTestingLevel.
	 * That is, with the regular analyzed requirements, with this policy set in
	 * the related Risk-based Quality Management Analysis setup.
	 * </p>
	 * <p>
	 * Getter method for the COM property
	...
	/**
	 * <p>
	 * Time it would take RnD to handle this requirement, as simple aggregative
	 * addition of RND efforts set in children that were visited in last
	 * analysis.
	 * </p>
	 * <p>
	 * Getter method for the COM property
	...
	/**
	 * <p>
	 * Count of all child requirements visited in last analysis that their
	 * Testing Efforts were customized (not set by analysis).
	 * </p>
	 * <p>
	 * Getter method for the COM property
	...
	/**
	 * <p>
	 * Count of all child requirements visited in last analysis that could not
	 * be analyzed due to missing Assessment or incomplete custom effort.
	 * </p>
	 * <p>
	 * Getter method for the COM property
	...
	/**
	 * <p>
	 * For each possible risk (pair of Risk and FC levels) - return the total
	 * Count of child requirements that were visited in last analysis and that
	 * are assessed to be in this Risk (Pair), and their Efforts were not
	 * customized.
	 * </p>
	 * <p>
	 * Getter method for the COM property
