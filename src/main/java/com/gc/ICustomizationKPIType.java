...
public interface ICustomizationKPIType extends Com4jObject {
	...
	/**
	 * <p>
	 * Indicates if the kpi type object has changed locally since last
	...
	/**
	 * <p>
	 * Indicates if the kpi type has been removed, but the deletion has not been
	 ...
	 * </p>
	 * 
	 * @return Returns a value of type com.gc.ICustomizationBreakdownTypes
	 */

	@DISPID(26)
	// = 0x1a. The runtime will prefer the VTID if present
	@VTID(52)
	com.gc.ICustomizationBreakdownTypes breakdownTypes();
