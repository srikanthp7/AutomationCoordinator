...
/**
 * The data that describes a specific use-case of the Test that owns this
 * configuration.
 */
@IID("{A9AA9D16-EBD7-46EC-AB5D-38495232D7F6}")
public interface ITestConfig extends com.gc.IBaseFieldExMail {
	// Methods:
	/**
	 * <p>
	...
	/**
	 * <p>
	 * Resets the selected parameter actual values of all the instances of the
	 * configuration.
	 * </p>
	 * 
	 * @param parameterIDs
