...
public interface IGroupingManager extends Com4jObject {
	...
	// = 0x1. The runtime will prefer the VTID if present
	@VTID(8)
	void filter(@MarshalAs(NativeType.Dispatch) com4j.Com4jObject pVal);
	...
	@VTID(9)
	int group(java.lang.String name);
	...
	// = 0x2. The runtime will prefer the VTID if present
	@VTID(10)
	void group(java.lang.String name, int pVal);
	...
	/**
	 * <p>
	 * Fetches the GroupList according to the Filter and Group values,
	 * overwriting the list in memory.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Checks if the GroupingManager contains any data. True if there is no
	 * data.
	 * </p>
	 * 
