...
public enum GRAPH_PROPERTIES implements ComEnum {
	...
	/**
	 * <p>
	 * Name of the field to sum the values of. The sum is displayed instead of
	 * the entities' count.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * In requirements module, if true, not-covered parent requirements are
	 * included as well.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * In test plan and test lab modules, defines whether XAxis subject or test
	 * set full paths should be displayed.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * In test plan and test lab modules, defines whether Group By subject or
	 * test set full paths should be displayed.
	 * </p>
	 * <p>
