...
/**
 * For HP use. Manages the sub-floders and child entities included in one
 * folder.
 */
@IID("{73598F2E-D89E-4144-B9B1-6A4C4D933276}")
public interface IBaseEntityFolder extends com.gc.ISysTreeNode {
	// Methods:
	/**
	 * <p>
	...
	/**
	 * <p>
	 * Gets a list of contained business entities according to specified
	 * pattern.
	 * </p>
	 * 
	 * @param pattern
	...
	@VTID(36)
	com.gc.IList findEntity(java.lang.String pattern,
