...
public interface IReq extends com.gc.IBaseFieldExMail {
	// Methods:
	/**
	 * <p>
	...
	/**
	 * <p>
	 * Assigns all the tests in the specified subject folder to cover this
	 * current requirement.
	 * </p>
	 * 
	 * @param subjectId
	...
	@VTID(42)
	void removeCoverage(@MarshalAs(NativeType.VARIANT) java.lang.Object vTest,
	...
	@VTID(43)
	com.gc.IList getCoverList(@Optional @DefaultValue("0") boolean recursive);
	...
	/**
	 * <p>
	 * Moves a requirement to being a child of a specified father in the
	 * requirements tree.
	 * </p>
	 * 
	 * @param newFatherId
	...
	/**
	 * <p>
	 * Adds the tests from the specified subject that match the input filter to
	 * the list of tests that cover the current requirement.
	 * </p>
	 * 
	 * @param subjectId
	 *            Mandatory int parameter.
	...
	@VTID(52)
	int addCoverageByFilter(int subjectId, int order,
			java.lang.String testFilter);

	/**
	 * <p>
	 * Gets the list of all tests that cover the current requirement and match
	 * the filter.
	 * </p>
	 * 
	 * @param testFilter
	...
	@VTID(53)
	com.gc.IList getCoverListByFilter(java.lang.String testFilter,
			@Optional @DefaultValue("0") boolean recursive);
