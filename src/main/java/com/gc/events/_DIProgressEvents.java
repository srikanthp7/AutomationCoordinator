...
public abstract class _DIProgressEvents {
	...
	@DISPID(1)
	public void onProgress(int current, int total, java.lang.String message) {
	...
	@DISPID(2)
	public void onDataAvailable(int errorCode) {
		throw new UnsupportedOperationException();
	}
	...
	@DISPID(3)
	public void onServerProgress(int time, java.lang.String message) {
		throw new UnsupportedOperationException();
	}
