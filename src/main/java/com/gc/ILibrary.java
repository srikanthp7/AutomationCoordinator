...
public interface ILibrary extends com.gc.IBaseFieldExMail {
	// Methods:
	/**
	 * <p>
	...
	/**
	 * <p>
	 * For HP use. Synchronizes another library baseline into the current
	 * library. Both libraries type may be either exportable or imported.
	 * </p>
	 * 
	 * @param srcLibrary
	...
	@VTID(33)
	int beginSync(com.gc.ILibraryInfo srcLibrary, int srcBaselineId,
			int comparisonId, com.gc.IList fieldsToSync);

	/**
	 * <p>
	 * For HP use. Returns the LibraryInfo of this library. The returned
	 * baseline data is meaningless (it is here only because it is a part of the
	 * LibraryInfo data).
	 * </p>
	 * <p>
	 ...
	 * </p>
	 * 
	 * @return Returns a value of type com.gc.ILibraryOperationResult
	 */

	@DISPID(33)
	// = 0x21. The runtime will prefer the VTID if present
	@VTID(35)
	com.gc.ILibraryOperationResult createBaselineVerification();
	...
	@VTID(36)
	com.gc.ILibraryOperationResult syncLibrariesVerification(
			com.gc.ILibraryInfo srcLibrary, int srcBaselineId, int comparisonId);
