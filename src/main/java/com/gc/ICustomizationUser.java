...
/**
 * Represents a user for purposes of adding and removing the user to and from
 * user groups.
 */
...
public interface ICustomizationUser extends Com4jObject {
	...
	/**
	 * <p>
	 * A text field that can be used to record user information as appropriate
	 * for the project.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Indicates if the user's data was updated since the last synchronization
	 * with the server.
	 * </p>
	 * <p>
	...
	@VTID(18)
	void removeFromGroup(@MarshalAs(NativeType.VARIANT) java.lang.Object group);
	...
	@VTID(19)
	void addToGroup(@MarshalAs(NativeType.VARIANT) java.lang.Object group);
	...
	@VTID(20)
	boolean in_Group(@MarshalAs(NativeType.VARIANT) java.lang.Object groupName);
	...
	// = 0x9. The runtime will prefer the VTID if present
	@VTID(21)
	void in_Group(@MarshalAs(NativeType.VARIANT) java.lang.Object groupName,
			boolean pVal);

	/**
	 * <p>
	 * If true, this user is marked for deletion, but the deletion is not yet
	 * committed.
	 * </p>
	 * <p>
	...
	@VTID(26)
	boolean inGroup(@MarshalAs(NativeType.VARIANT) java.lang.Object groupName);
	...
	// = 0xd. The runtime will prefer the VTID if present
	@VTID(27)
	void inGroup(@MarshalAs(NativeType.VARIANT) java.lang.Object groupName,
			boolean pVal);
