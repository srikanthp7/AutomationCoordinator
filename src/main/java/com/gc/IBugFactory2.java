...
public interface IBugFactory2 extends com.gc.IBugFactory {
	// Methods:
	/**
	 * <p>
	 * Creates multi project summary graph either of the number of defects or
	 * the time to fix (estimated or actual).
	 * </p>
	 * 
	 * @param xAxisField
	...
	/**
	 * <p>
	 * For HP use. Creates a graph that shows the history of changes to specific
	 * Defect fields for each time interval displayed.
	 * </p>
	 * 
	 * @param groupByField
	 *            Optional parameter. Default value is ""
