...
/**
 * Deprecated. Use ITestFolder. Represents a subject folder in a Quality Center
 * subject tree.
 */
@IID("{0F500A37-F2F1-4079-9BE7-48C1DA715E27}")
public interface ISubjectNode extends com.gc.ISysTreeNode {
	// Methods:
	/**
	 * <p>
	...
	/**
	 * <p>
	 * Finds tests within the current subject folder whose name matches the
	...
	@VTID(28)
	com.gc.IList findTests(java.lang.String pattern,
	...
	@VTID(32)
	void move(@MarshalAs(NativeType.VARIANT) java.lang.Object parent);
