...
public enum TDAPI_COMPARISON_CHANGE_TYPES implements ComEnum {
	...
	/**
	 * <p>
	 * ActuallyMoved. This type used only in the server and DB. OTA client (UI)
	 * cannot receive this type while asking to get comparison change type of
	 * entity.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * MovedAndModified. This type used to indicate entities that were moved and
	 * modified.
	 * </p>
	 * <p>
