...
public interface IBugFactory extends com.gc.IBaseFactoryEx {
	// Methods:
	/**
	 * <p>
	 * Creates a summary graph either of the number of defects or the time to
	 * fix (estimated or actual).
	 * </p>
	 * 
	 * @param xAxisField
	...
	/**
	 * <p>
	 * Creates a graph showing status at specific points: either defect
	 * accumulation or time to fix (estimated or actual).
	 * </p>
	 * 
	 * @param groupByField
	 *            Optional parameter. Default value is ""
	 ...
	 *            Optional parameter. Default value is 10
	...
	@VTID(20)
	com.gc.IList findSimilarBugs(java.lang.String pattern,
			@Optional @DefaultValue("10") int similarityRatio);

	/**
	 * <p>
	 * Creates a graph that shows the history of changes to specific Defect
	 * fields for each time interval displayed.
	 * </p>
	 * 
	 * @param groupByField
	 *            Optional parameter. Default value is ""
