...
public interface ICustomizationBreakdownType extends Com4jObject {
	...
	/**
	 * <p>
	 * Indicates if the Breakdown Type has been created but not posted to the
	 * server.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Indicates if the Breakdown Type object has changed locally since last
	...
	/**
	 * <p>
	 * Indicates if the Breakdown Type has been removed, but the deletion has
	 * not been posted to the server.
	 * </p>
	 * <p>
