...
public enum TDMAIL_FLAGS implements ComEnum {
	...
	/**
	 * <p>
	 * Use the Comment argument of the Mail method as the message body. Used by
	 * UI when sending custom e-mail.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Applies to any email message. Indicates that if message sent in ASYNC
	 * mode and failed, it will be re-sent to sender.
	 * </p>
	 * <p>
