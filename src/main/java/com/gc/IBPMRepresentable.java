...
public interface IBPMRepresentable extends Com4jObject {
	...
	/**
	 * <p>
	 * The bpm link factory of the object represented that enables viewing the
	 * bpm links.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Checks if the current represented object has at least one associated bpm
	 * link.
	 * </p>
	 * <p>
	...
	@VTID(9)
	com.gc.IList getLinkedTests(boolean includeIndirectLinkage,
			boolean includeChildren, java.lang.String filter);
