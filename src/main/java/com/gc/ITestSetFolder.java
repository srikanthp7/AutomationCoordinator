...
/**
 * Deprecated. Use ITestLabFolder. Manages the tests and test sets included in
 * one test set folder.
 */
@IID("{E9E2BCFE-CAAC-492D-A210-C2E49A68C78F}")
public interface ITestSetFolder extends com.gc.ISysTreeNode {
	// Methods:
	/**
	 * <p>
	 ...
	 * @param deleteTestSets
	 *            Optional parameter. Default value is false
	 */

	@VTID(31)
	void removeNodeEx(@MarshalAs(NativeType.VARIANT) java.lang.Object node,
	...
	@VTID(32)
	void move(@MarshalAs(NativeType.VARIANT) java.lang.Object father);
	...
	/**
	 * <p>
	 * Gets the list of test sets contained in the folder that match the
	 * specified pattern.
	 * </p>
	 * 
	 * @param pattern
	...
	@VTID(36)
	com.gc.IList findTestSets(java.lang.String pattern,
