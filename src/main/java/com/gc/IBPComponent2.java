...
public interface IBPComponent2 extends com.gc.IBPComponent {
	// Methods:
	/**
	 * <p>
	...
	@VTID(40)
	com.gc.IList getPrecedingOutputBpParameters();
	...
	/**
	 * <p>
	 * For HP use. The IDs of the input BP Params that are referencing output
	 * parameters and their iterations mismatch
	 * </p>
	 * <p>
	...
	@VTID(43)
	com.gc.IList inBPParamsIdsWithIterationsMismatch();
	...
	// = 0x1f. The runtime will prefer the VTID if present
	@VTID(44)
	void inBPParamsIdsWithIterationsMismatch(com.gc.IList pList);
