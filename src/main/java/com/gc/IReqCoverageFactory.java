...
public interface IReqCoverageFactory extends com.gc.ICoverageFactory {
	// Methods:
	/**
	 * <p>
	 * Indicates if the actions of the factory are applied recursively to
	 * requirement's children.
	 * </p>
	 * <p>
