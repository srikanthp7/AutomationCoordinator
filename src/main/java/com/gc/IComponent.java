...
public interface IComponent extends com.gc.IBaseFieldEx {
	// Methods:
	/**
	 * <p>
	...
	@VTID(26)
	com.gc.IList businessProcesses();
	...
	/**
	 * <p>
	 * Checks if the component has been marked deleted by a user but is still in
	 * use in a test.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * For backward compatibility with versions prior to 9.0. Wrap component's
	 * step in HTML format.
	 * </p>
	 */
