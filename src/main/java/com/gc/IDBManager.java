...
public interface IDBManager extends Com4jObject {
	...
	@VTID(7)
	void createDatabase(int dbType, java.lang.String dbName,
	...
	@VTID(8)
	void removeDatabase(java.lang.String dbName);
	...
	// = 0x3. The runtime will prefer the VTID if present
	@VTID(10)
	void adminUserName(java.lang.String pVal);
	...
	// = 0x4. The runtime will prefer the VTID if present
	@VTID(12)
	void domain(java.lang.String pVal);
	...
	// = 0x5. The runtime will prefer the VTID if present
	@VTID(14)
	void adminUserPassword(java.lang.String pVal);
