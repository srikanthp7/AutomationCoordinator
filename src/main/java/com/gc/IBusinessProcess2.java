...
public interface IBusinessProcess2 extends com.gc.IBusinessProcess {
	// Methods:
	/**
	 * <p>
	 * Deprecated. Use BPOutputParamFactory of IBusinessProcess4. The list of
	 * flow output parameters for the test.
	 * </p>
	 * <p>
	...
	@VTID(65)
	com.gc.IList flowOutputParameters();
	...
	/**
	 * <p>
	 * Deprecated. Use BPOutputParamFactory of IBusinessProcess4. Adds a flow
	 * output parameter to the test.
	 * </p>
	 * 
	 * @param pSrcBPParam
	...
	com4j.Com4jObject addFlowOutputParam(
			...
			int iteration, java.lang.String name);

	/**
	 * <p>
	 * Deprecated. Use BPOutputParamFactory of IBusinessProcess4. Deletes the
	 * flow output parameter from the test.
	 * </p>
	 * 
	 * @param pShadowCompParam
	 *            Mandatory com4j.Com4jObject parameter.
	 */
	...
	/**
	 * <p>
	 * For HP use. Checks whether the test contains at least one dynamic date
	 * parameters values.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * For HP use. Returns the runtime flow parameters. If groupLevel is 1,
	 * parameters are grouped by components. If groupLevel is 2,by iterations.
	 * </p>
	 * 
	 * @param groupLevel
	 *            Mandatory int parameter.
	...
	@VTID(72)
	com.gc.IList getParameterGroups(int groupLevel);

	/**
	 * <p>
	 * For HP use. Returns the list of IComponent objects in which the IRTParam
	 * value is used.
	 * </p>
	 * 
	 * @param pRTParam
	...
	@VTID(73)
	com.gc.IList getRTParamOccurrences(
