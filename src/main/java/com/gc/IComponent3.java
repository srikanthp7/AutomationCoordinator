...
public interface IComponent3 extends com.gc.IComponent2 {
	// Methods:
	/**
	 * <p>
	 * For HP use. Returns the IBusinessProcess that represents the flow aspect
	 * of this component.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Saves the component snapshot. The snapshot file name must be
	 * 'Picture.png'.
	 * </p>
	 * 
	 * @param snapshotSourcePath
