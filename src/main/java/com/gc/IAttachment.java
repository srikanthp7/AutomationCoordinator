...
public interface IAttachment extends com.gc.IBaseField {
	// Methods:
	/**
	 * <p>
	...
	@VTID(22)
	java.lang.String name(@Optional @DefaultValue("0") int viewFormat);
	...
	/**
	 * <p>
	 * If the attachment is a file, an array of bytes. If a reference to file,
	 * the path or URL.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * If a file, the file location. If a virtual file, the location for the
	 * attachment before it is uploaded to the server. If a URL, the link
	 * address.
	 * </p>
	 * <p>
	...
	@VTID(28)
	void load(boolean synchronize, Holder<java.lang.String> rootPath);
	...
	/**
	 * <p>
	 * Deprecated. The ExtendedStorage object of this attachment. Applies only
	 * to file attachments.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Obsolete.Use IAttachment3 FileSizeEx instead. The attachment file size in
	 * bytes.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Renames the attachment on the server. The attachment must be uploaded
