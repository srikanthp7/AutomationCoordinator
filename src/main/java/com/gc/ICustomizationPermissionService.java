...
public interface ICustomizationPermissionService extends Com4jObject {
	...
	/**
	 * <p>
	 * Checks whether the currently connected user can add the specified type of
	 * entity.
	 * </p>
	 * 
	 * @param tableName
	...
	/**
	 * <p>
	 * Checks whether the currently connected user can remove the specified type
	 * of entity.
	 * </p>
	 * 
	 * @param pBaseField
	...
	@VTID(8)
	void verifyRemoveItem(com.gc.IBaseField pBaseField,
	...
	@VTID(9)
	java.lang.String fieldOwner(com.gc.IBaseField pBaseField);

	/**
	 * <p>
	 * Checks whether the currently connected user can modify the specified type
	 * of entity.
	 * </p>
	 * <p>
