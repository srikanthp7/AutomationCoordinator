...
public interface ICoverableReq extends Com4jObject {
	...
	/**
	 * <p>
	 * Adds the test instance to the list of test instances that cover the
	 * current requirement.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Adds the test instances from the specified test set that match the input
	 * filter to the list of test instances that cover the current requirement.
	 * </p>
	 * 
	 * @param testSetID
	 *            Mandatory int parameter.
	 * @param testInstanceFilter
	...
	@VTID(11)
	void addSubjectToCoverage(int subjectId, java.lang.String testFilter);
