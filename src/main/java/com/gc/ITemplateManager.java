...
/**
 * Services for performing policy enforcement (Cross Project Customization)
 * operations.
 */
...
public interface ITemplateManager extends Com4jObject {
	...
	/**
	 * <p>
	 * Verifies the template's customization against a linked project (perform
	 * conflicts analysis).
	 * </p>
	 * <p>
