...
/**
 * Represents a basic data field or entity, such as an attachment. Use the
 * properties and methods to perform field-related actions, such as setting and
 * refreshing field values.
 */
@IID("{8937B744-DE14-4E34-9A56-4E9E308B1863}")
public interface IBaseFieldEx extends com.gc.IBaseField {
	// Methods:
	/**
	 * <p>
