...
public interface ITDConnection extends Com4jObject {
	...
	/**
	 * <p>
	 * Checks if the Open Test Architecture API server connection is
	 * initialized.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * For HP use. Initializes the Open Test Architecture API server connection
	...
	@VTID(19)
	void initConnection(java.lang.String serverName,
	...
	@VTID(21)
	void connectProject(java.lang.String projectName,
			java.lang.String userName,
	...
	/**
	 * <p>
	 * The projects that are available in the domain to which Quality Center is
	 * connected.
	 * </p>
	 * <p>
	...
	@VTID(23)
	com.gc.IList projectsList();

	@VTID(23)
	@ReturnValue(type = NativeType.VARIANT, defaultPropertyThrough = { com.gc.IList.class })
	java.lang.Object projectsList(int index);
	...
	/**
	 * <p>
	 * For HP use. Allocates a license type according to the LicenseType
	 * parameter.
	 * </p>
	 * 
	 * @param licenseType
	...
	@VTID(33)
	com.gc.IList fields(java.lang.String dataType);
	...
	@VTID(38)
	com.gc.IList usersList();

	@VTID(38)
	@ReturnValue(type = NativeType.VARIANT, defaultPropertyThrough = { com.gc.IList.class })
	java.lang.Object usersList(int index);
	...
	/**
	 * <p>
	 * Disabled by default security settings. Use the entity-level extended
	 * storage property.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * The path of the server side repository directory for the database
	 * repository type.
	 * </p>
	 * <p>
	...
	@VTID(41)
	java.lang.String directoryPath(int nType);
	...
	@VTID(46)
	void purgeRuns(java.lang.String testSetFilter, int keepLast,
			@MarshalAs(NativeType.VARIANT) java.lang.Object dateUnit,
			int unitCount, boolean stepsOnly);
	...
	@VTID(48)
	void getLicenseStatus(int clientType, Holder<Integer> inUse,
			Holder<Integer> max);
	...
	@VTID(51)
	java.lang.String tdParams(java.lang.String request);
	...
	/**
	 * <p>
	 * Checks if the specified module is visible to the connected user. This
	 * property is used for Quality Center UI programming and has no function in
	...
	@VTID(59)
	void initConnectionEx(java.lang.String serverName);
	...
	@VTID(60)
	com.gc.IList projectsListEx(java.lang.String domainName);
	...
	@VTID(61)
	void connectProjectEx(java.lang.String domainName,
			java.lang.String projectName, java.lang.String userName,
			@Optional @DefaultValue("") java.lang.String password);
	...
	@VTID(62)
	com.gc.IList domainsList();

	@VTID(62)
	@ReturnValue(type = NativeType.VARIANT, defaultPropertyThrough = { com.gc.IList.class })
	java.lang.Object domainsList(int index);
	...
	@VTID(63)
	void connectToVCSAs(java.lang.String userName, java.lang.String password,
			java.lang.String copyDesStep);

	/**
	 * <p>
	 * Allocates multiple licenses types according to the LicensesType
	 * parameter.
	 * </p>
	 * 
	 * @param licensesType
	...
	@VTID(64)
	void getLicenses(int licensesType, Holder<java.lang.String> pVal);
	...
	/**
	 * <p>
	 * For HP use. Allows repeat call to InitConnection,ReleaseConnection,
	 * ConnectProject and DisconnectProject.
	 * </p>
	 * <p>
	...
	@VTID(73)
	void synchronizeFollowUps(java.lang.String password);
	...
	/**
	 * <p>
	 * Indicates if formatted memo and description fields are returned as plain
	...
	@VTID(79)
	void clientType(java.lang.String newVal,
	...
	@VTID(82)
	void getTDVersion(Holder<java.lang.String> pbsMajorVersion,
