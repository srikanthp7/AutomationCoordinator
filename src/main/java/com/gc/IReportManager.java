...
public interface IReportManager extends Com4jObject {
	...
	/**
	 * <p>
	 * Invokes a task that generates a full report data file on the server by
	 * sending a full configuration XML to the server.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Invokes a task that generates a report preview data file on the server by
	 * sending a full configuration XML to the server.
	 * </p>
	 * 
	 * @param reportConfigXml
	...
	@VTID(14)
	void uploadReportProjectTemplateFile(int tmpltID,
	...
	com4j.Com4jObject createReportUserTemplate(java.lang.String fileName,
			com.gc.IList pFields, java.lang.String tmplType,
			int owningReportID, java.lang.String localFilePath);
