...
public interface ITSTest3 extends com.gc.ITSTest2 {
	// Methods:
	/**
	 * <p>
	...
	/**
	 * <p>
	 * Generates a new Configuration based on this test instance. Connects the
	 * instance to the new created configuration, and returns its ID.
	 * </p>
	 * 
	 * @param testConfigurationName
