...
/**
 * Deprecated. Use ICustomizationSubtype. Represents the Customization type of
 * an entity.
 */
...
public interface ICustomizationType extends Com4jObject {
	...
	/**
	 * <p>
	 * Removes the CustomizationTypedField specified by FieldName from this
	 * type.
	 * </p>
	 * 
	 * @param fieldName
	 ...
	 * 
	 * @param pBitMap
	 *            Mandatory com.gc.IStream parameter.
	 */

	@DISPID(7)
	// = 0x7. The runtime will prefer the VTID if present
	@VTID(15)
	void icon(com.gc.IStream pBitMap);

	/**
	 * <p>
	 * The editing control CLSID for COM or the fully qualified assembly name
	 * for .NET.
	 * </p>
	 * <p>
