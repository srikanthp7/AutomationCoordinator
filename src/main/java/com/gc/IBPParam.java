...
public interface IBPParam extends com.gc.IBaseField {
	// Methods:
	/**
	 * <p>
	 * The output BPParameter object that is the source of the value for this
	 * parameter.
	 * </p>
	 * <p>
	...
	// = 0x14. The runtime will prefer the VTID if present
	@VTID(21)
	void reference(@MarshalAs(NativeType.Dispatch) com4j.Com4jObject pVal);
	...
	/**
	 * <p>
	 * The name of the ComponentParam object from which this BPParam was
	 * created.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Indicates if the ComponentParam from which this BPParam was created is an
	 * output parameter. If 0, input parameter.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * The position of the ComponentParam object from which this BPParam was
	 * created.
	 * </p>
	 * <p>
