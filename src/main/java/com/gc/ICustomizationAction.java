...
public interface ICustomizationAction extends Com4jObject {
	...
	/**
	 * <p>
	 * Adds a user group to the list of user groups for which the current action
	 * is allowed.
	 * </p>
	 * 
	 * @param group
	...
	@VTID(9)
	void addGroup(@MarshalAs(NativeType.VARIANT) java.lang.Object group);

	/**
	 * <p>
	 * Removes the specified user group from the list of groups for which the
	...
	@VTID(10)
	void removeGroup(@MarshalAs(NativeType.VARIANT) java.lang.Object group);
	...
	// = 0x5. The runtime will prefer the VTID if present
	@VTID(12)
	void ownerGroup(@MarshalAs(NativeType.Dispatch) com4j.Com4jObject pVal);

	/**
	 * <p>
	 * Indicates if the object has been modified since last synchronized with
	 * server.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Checks if the group specified by the Group parameter has permission to
	...
	/**
	 * <p>
	 * Checks if the user group specified by the Group parameter is the owner of
	 * the current action.
	 * </p>
	 * <p>
	...
	@VTID(16)
	boolean isOwnerGroup(@MarshalAs(NativeType.VARIANT) java.lang.Object group);

	/**
	 * <p>
	 * Checks if the user specified by the User parameter is permitted to
	 * perform the current action.
	 * </p>
	 * <p>
	...
	@VTID(17)
	boolean isUserPermited(@MarshalAs(NativeType.VARIANT) java.lang.Object user);
