...
public interface IDashboardFolderFactory extends com.gc.IBaseFactoryEx {
	// Methods:
	/**
	 * <p>
	 * Returns the page IDs of those children of the specified folders that
	 * contain private analysis items.
	 * </p>
	 * 
	 * @param pIdsList
	...
	@VTID(17)
	com.gc.IList getChildPagesWithPrivateItems(com.gc.IList pIdsList);
