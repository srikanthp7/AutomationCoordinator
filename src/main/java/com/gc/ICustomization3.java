...
public interface ICustomization3 extends com.gc.ICustomization2 {
	// Methods:
	/**
	 * <p>
	...
	/**
	 * <p>
	 * Returns the names of the data tables that have a user label defined as
	 * comma-separated pairs of table names and user labels.
	 * </p>
	 * <p>
	...
	@VTID(25)
	com.gc.IList customizableEntitiesTables();
