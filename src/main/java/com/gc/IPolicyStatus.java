...
public interface IPolicyStatus extends Com4jObject {
	...
	// = 0x5. The runtime will prefer the VTID if present
	@VTID(12)
	void policyUpdateBlockComment(java.lang.String psComment);
	...
	/**
	 * <p>
	 * Checks whether the connected project is up-to-date with its linked
	 * template.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * The XML document containing the data of the last propagation performed on
	 * the project.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * The XML document containing the data of the last verification performed
	 * on the project.
	 * </p>
	 * <p>
	...
	@VTID(20)
	com.gc.IList administrators();

	@VTID(20)
	@ReturnValue(type = NativeType.VARIANT, defaultPropertyThrough = { com.gc.IList.class })
	java.lang.Object administrators(int index);

	/**
	 * <p>
	 * The Policy Enforcement Status object containing details of the project's
	 * linked template.
	 * </p>
	 * <p>
