...
/**
 * Services to create and maintain lists. Use any factory object to create any
 * number of list instances for objects in the factory.
 */
...
public interface IList extends Com4jObject, Iterable<Com4jObject> {
	...
	@VTID(8)
	void add(@MarshalAs(NativeType.VARIANT) java.lang.Object vNew);
	...
	/**
	 * <p>
	 * Gets an IEnumVARIANT enumerator. For information on the IEnumVARIANT, see
	...
	@VTID(12)
	void insert(int pos, @MarshalAs(NativeType.VARIANT) java.lang.Object vNew);
