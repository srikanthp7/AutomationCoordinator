...
public interface ICustomizationRBT2 extends com.gc.ICustomizationRBT {
	// Methods:
	/**
	 * <p>
	...
	/**
	 * <p>
	 * The lower threshold of Risk assessment for each Functional Complexity
	 * level.
	 * </p>
	 * <p>
	...
	// = 0x40. The runtime will prefer the VTID if present
	@VTID(38)
	void fcLevelRiskLowerThreshold(int fcLevel, int pLowerThreshold);

	/**
	 * <p>
	 * Translate Functional Complexity from TDAPI_RBT_FC_LEVELS to its name in
	 * the database.
	 * </p>
	 * 
	 * @param fcLevelEnum
	...
	/**
	 * <p>
	 * Calculate the Functional Complexity level from the sum of all the values'
	 * weights.
	 * </p>
	 * 
	 * @param answersWeight
	...
	@VTID(41)
	int riskCalculationMatrix(int biLevel, int fpLevel);
	...
	// = 0x43. The runtime will prefer the VTID if present
	@VTID(42)
	void riskCalculationMatrix(int biLevel, int fpLevel, int pRiskLevel);

	/**
	 * <p>
	 * Translate Failure Probability from its name in the database to
	 * TDAPI_RBT_FP_LEVELS.
	 * </p>
	 * 
	 * @param fpLevel
	...
	/**
	 * <p>
	 * Translate Business Criticality from its name in the database to
	 * TDAPI_RBT_BI_LEVELS.
	 * </p>
	 * 
	 * @param biLevel
