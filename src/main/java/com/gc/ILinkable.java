...
public interface ILinkable extends Com4jObject {
	...
	/**
	 * <p>
	 * The bug link factory that manages the links of the current object to its
	 * associated defects.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * The link factory of the current defect object that enables viewing the
	 * links. Defined only for Bug objects.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Checks if the current Bug object has at least one associated object that
	 * is not another Bug object. Defined only for Bug objects.
	 * </p>
	 * <p>
