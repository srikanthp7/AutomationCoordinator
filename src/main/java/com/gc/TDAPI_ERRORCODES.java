...
public enum TDAPI_ERRORCODES implements ComEnum {
	...
	/**
	 * <p>
	 * Cannot delete Application Area resource since it's in use by other
	 * objects.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Copied Analysis Element either does not exist or is located in a private
	 * sub tree to which the logged in user has no access.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Target folder either does not exist or is located in a private sub tree
	 * to which the logged in user has not access.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Creation of Threshold Value with owner type KPIMilestoneScopeItem is not
	 * allowed. Call CopyThresholdValues first.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * You cannot delete all the test configurations. You must keep at least one
	...
	/**
	 * <p>
	 * Failed to delete test set. Some of the instances are of configurations
	 * that do not exist. You may need to check in the tests before you can
	 * delete the test set.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Failed to delete instances. Some of the instances are of configurations
	 * that do not exist. You may need to check in the tests in order to delete
	 * the instances.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * The mode flag is invalid for the requirement options: copy, remove and
	 * find.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * No permission to modify design steps - steps won't be copied to the
	 * corresponding test.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Cannot create one of the following objects: path, file or ES object
	 * itself.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Cannot Commit Risk-based Quality Management customizations due to failed
	 * validators.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Cannot create release coverage progress graph. One or more cycles are
	...
	/**
	 * <p>
	 * Some of the tests were not added since they do not belong to the required
	 * baseline or they do not support pinning to a baseline.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Some of the test configurations were not added to the test set because
	 * they were never checked in.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Some of the test configurations were not added since they do not belong
	 * to the required baseline or they do not support pinning to a baseline.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * An Illegal put_field command was received (Only actual_value may be
	 * modified).
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * The baseline from which the library was imported was deleted. Comparison
	 * is impossible.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * The baseline, which was created after last library import or sync, was
	 * deleted. Synchronization is impossible.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Compare or synchronization operations could not start because one of the
	...
	/**
	 * <p>
	 * A cross-project field intersection operation failed because of an invalid
	 * project state.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * A cross-project field intersection operation failed because the selected
	...
	/**
	 * <p>
	 * Indicates that a cross-project field intersection operation has failed
	 * because the selected entity or entities are not supported by one or more
	 * projects.
	 * </p>
	 * <p>
