...
/**
 * Deprecated. Use ParameterValue and ParameterValueFactory. A collection of
 * test parameters.
 */
...
public interface IStepParams extends Com4jObject {
	...
	// = 0x2. The runtime will prefer the VTID if present
	@VTID(9)
	void paramValue(@MarshalAs(NativeType.VARIANT) java.lang.Object vParam,
	...
	@VTID(10)
	void clearParam(@MarshalAs(NativeType.VARIANT) java.lang.Object vParam);
	...
	// = 0x4. The runtime will prefer the VTID if present
	@VTID(12)
	void paramType(@MarshalAs(NativeType.VARIANT) java.lang.Object vParam,
			java.lang.String pVal);
	...
	/**
	 * <p>
	 * The name of the parameter in the specified position in the StepParams
	...
	@VTID(16)
	int type(@MarshalAs(NativeType.VARIANT) java.lang.Object vParam);
	...
	@VTID(19)
	void addParam(java.lang.String paramName, java.lang.String paramType);
