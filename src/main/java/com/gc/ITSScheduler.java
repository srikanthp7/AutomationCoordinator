...
public interface ITSScheduler extends Com4jObject {
	...
	@VTID(7)
	void run(@Optional @MarshalAs(NativeType.VARIANT) java.lang.Object testData);
	...
	@VTID(8)
	void stop(@Optional @MarshalAs(NativeType.VARIANT) java.lang.Object testData);
	...
	/**
	 * <p>
	 * The time to wait for response before either sending test to another host
	 * in group or failing.
	 * </p>
	 * <p>
	...
	// = 0x9. The runtime will prefer the VTID if present
	@VTID(20)
	void runOnHost(@MarshalAs(NativeType.VARIANT) java.lang.Object tsTestId,
	...
	// = 0xa. The runtime will prefer the VTID if present
	@VTID(22)
	void vM_Config(@MarshalAs(NativeType.VARIANT) java.lang.Object tsTestId,
			java.lang.String pVal);
