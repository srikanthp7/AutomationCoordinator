...
public interface ITDConnection2 extends com.gc.ITDConnection {
	// Methods:
	/**
	 * <p>
	...
	/**
	 * <p>
	 * Confirms that the user is authorized to use Quality Center. If
	 * authorized, the user is logged in and can connect to projects.
	 * </p>
	 * 
	 * @param userName
	...
	/**
	 * <p>
	 * The list of domain names that the current logged in user is permitted to
	 * view.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * The list of projects in the specified domain that the current logged in
	...
	@VTID(96)
	com.gc.IList visibleProjects(java.lang.String domainName);
