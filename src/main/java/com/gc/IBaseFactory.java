...
/**
 * Provides basic object basic factory services, such as adding and removing
 * factory child objects and creating lists of child objects.
 */
...
public interface IBaseFactory extends Com4jObject {
	...
	/**
	 * <p>
	 * Removes item from the database. Removal takes place immediately, without
	 * a Post.
	 * </p>
	 * 
	 * @param itemKey
	...
	@VTID(11)
	void removeItem(@MarshalAs(NativeType.VARIANT) java.lang.Object itemKey);
