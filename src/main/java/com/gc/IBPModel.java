...
public interface IBPModel extends com.gc.IBaseFieldExMail {
	// Methods:
	/**
	 * <p>
	 * The BPModel name.
	...
	@VTID(33)
	boolean importPostProcess(boolean updateFlag, int parentId);
	...
	@VTID(34)
	boolean handleRepresentativeRequirements(boolean updateFlag, int parentId);
