...
/**
 * Represents a storage structure used to transfer files between the server and
 * client file system and delete files.
 */
...
public interface IExtendedStorage extends Com4jObject {
	...
	@VTID(9)
	void save(@Optional @DefaultValue("*.*") java.lang.String fSysFilter,
			@Optional @DefaultValue("0") boolean synchronize);
	...
	/**
	 * <p>
	 * Deprecated. The location on the server from which to download or to which
	 * to upload.
	 * </p>
	 * <p>
	...
	@VTID(17)
	java.lang.String progress(Holder<Integer> total, Holder<Integer> current);

	/**
	 * <p>
	 * Gets the last error that occurred during asynchronous load and save
	 * operations.
	 * </p>
	 */
	...
	@VTID(19)
	boolean saveEx(java.lang.String fSysFilter, boolean synchronize,
			Holder<com.gc.IList> pVal);
	...
	@VTID(20)
	java.lang.String loadEx(java.lang.String fSysFilter, boolean synchronize,
			Holder<com.gc.IList> pVal, Holder<Boolean> pNonFatalErrorOccured);
