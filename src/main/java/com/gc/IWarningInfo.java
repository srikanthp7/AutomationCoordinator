...
public interface IWarningInfo extends Com4jObject {
	...
	@VTID(3)
	void setWarning(int warningCode, java.lang.String warningDescription,
	...
	@VTID(4)
	void setWarningFromFrec(java.lang.String warningFrec,
			com4j.Com4jObject pCaller);
	 ...
	 * @param pWarningDescription
	 *            Mandatory Holder<java.lang.String> parameter.
	 */

	@VTID(6)
	void getWarning(Holder<Integer> pWarningCode,
