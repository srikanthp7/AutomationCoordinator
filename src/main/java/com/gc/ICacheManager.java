...
public interface ICacheManager extends Com4jObject {
	...
	@VTID(8)
	java.lang.String cachedData(java.lang.String dataType,
	...
	// = 0x2. The runtime will prefer the VTID if present
	@VTID(9)
	void cachedData(java.lang.String dataType, java.lang.String dataCacheKey,
	...
	@VTID(10)
	void removeCachedData(java.lang.String dataType,
			java.lang.String dataCacheKey, int timeDelay);
